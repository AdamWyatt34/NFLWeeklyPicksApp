...
namespace NFLWeeklyPicksAPI.Migrations
{
    ...
    [Migration("20220814113006_pick-points")]
    partial class pickpoints
    {
            ...
            modelBuilder.Entity("NFLWeeklyPicksAPI.Models.Entities.UserPickPoints", b =>
                {
                    b.HasOne("NFLWeeklyPicksAPI.Models.Entities.UserPickLineItems", "UserPickLineItem")
                        .WithOne("PickPoints")
                        .HasForeignKey("NFLWeeklyPicksAPI.Models.Entities.UserPickPoints", "UserPickLineItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
